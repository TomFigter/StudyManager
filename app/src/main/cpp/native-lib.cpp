...
Java_com_thtf_leanpackage_MainActivity_rdSound(JNIEnv *env, jobject instance, jstring path_) {
     ...
     * 设置buffer队列
     */
    SLDataLocator_AndroidBufferQueue loc_bq = {SL_DATALOCATOR_ANDROIDSIMPLEBUFFERQUEUE, 2};
    /**
     * 设置录制规格：PCM ,2声道,采集率 44100HZ,16bit
     */
...
extern "C"
JNIEXPORT void JNICALL
Java_com_thtf_leanpackage_MainActivity_rdStop(JNIEnv *env, jobject instance) {
